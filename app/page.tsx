...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#f8f9fb] text-[#191c1e] selection:bg-[#dfe0ff] selection:text-[#0f144c]">
      ...
      <main>
              ...
              <div className="md:col-span-12 lg:col-span-7 bg-[#f2f4f6] rounded-[2.5rem] p-[32px] flex flex-col lg:flex-row gap-[32px] items-center premium-shadow border border-white hover:border-[#edeef0] transition-all opacity-0 translate-y-12">
                <div className="flex-1 order-2 lg:order-1">
                  ...
                  <div className="flex items-center -space-x-3">
                    ...
                    <div className="w-12 h-12 bg-[#050a44] border-4 border-white flex items-center justify-center text-white text-[10px] font-bold">+47</div>
                  </div>
                </div>
        ...
        <section className="py-24 overflow-hidden bg-[#050a44] text-white relative">
          ...
          <div className="px-4 md:px-[64px] max-w-[1440px] mx-auto flex flex-col md:flex-row justify-around items-center text-center gap-[32px] relative z-10 opacity-0 translate-y-12">
            ...
            <div className="w-px h-24 bg-white/10 hidden md:block"></div>
            <div className="space-y-2">
              <div className="text-[64px] font-black tracking-tighter leading-none mb-2">200<span className="text-[#feb700]">+</span></div>
              <div className="text-[14px] leading-[1.2] tracking-[0.2em] font-bold text-[#bdc2ff] uppercase">Cities Served</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-white">
          <div className="px-4 md:px-[64px] max-w-[1440px] mx-auto text-center opacity-0 translate-y-12">
            <h2 className="text-[40px] md:text-[56px] font-bold mb-6 text-[#050a44] leading-[1.2]">Ready to elevate your journey?</h2>
            <p className="text-[18px] leading-[1.6] text-[#46464f] mb-12 max-w-2xl mx-auto">Join thousands of travelers who experience transport as luxury. Book your first premium journey with VIVID today.</p>
            <button onClick={() => router.push('/search')} className="px-8 py-4 bg-[#050a44] text-white rounded-2xl text-[16px] leading-[1.4] font-semibold hover:bg-[#feb700] hover:text-[#050a44] transition-all shadow-lg hover:shadow-2xl flex items-center gap-2 mx-auto">
              <span>Book Now</span>
      ...
      {/* Footer */}
      <footer className="bg-[#050a44] text-white border-t border-white/10">
        <div className="px-4 md:px-[64px] max-w-[1440px] mx-auto py-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-20">
            <div>
              <h4 className="text-[16px] leading-[1.4] font-bold mb-6">VIVID</h4>
              <p className="text-[14px] leading-[1.6] text-[#bdc2ff] opacity-80">Redefining premium travel through technology and hospitality. Excellence in every journey.</p>
            </div>
            <div>
              <h4 className="text-[16px] leading-[1.4] font-bold mb-6">Product</h4>
              <ul className="space-y-4 text-[14px] leading-[1.6] text-[#bdc2ff] opacity-80">
            ...
            <div>
              <h4 className="text-[16px] leading-[1.4] font-bold mb-6">Company</h4>
              <ul className="space-y-4 text-[14px] leading-[1.6] text-[#bdc2ff] opacity-80">
            ...
            <div>
              <h4 className="text-[16px] leading-[1.4] font-bold mb-6">Contact</h4>
              <ul className="space-y-4 text-[14px] leading-[1.6] text-[#bdc2ff]">
